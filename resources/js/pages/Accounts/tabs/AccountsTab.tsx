...
export default function AccountsTab({ initialAccounts, initialGroups, filters }: AccountsTabProps) {
    ...
    // State for search (local for input, synced with router)
    ...
    const handleCreateSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('accounts.store'), createForm, {
            onSuccess: () => {
    ...
    const handleDelete = () => {
        ...
        router.delete(route('accounts.destroy', accountToDelete.id), {
            ...
            onError: (errors) => {
                ...
                alert(firstError || 'Failed to delete account');
            },
    ...
    const handleToggleStatus = (id: number) => {
        router.post(route('accounts.toggleStatus', id), {}, {
            preserveScroll: true,
    ...
    const accounts = initialAccounts.data || [];
        ...
        <div className="flex flex-col gap-6">
                        ...
                        <DialogContent className="max-h-[90vh] overflow-y-auto">
                            ...
                            <form onSubmit={handleCreateSubmit} className="space-y-6">
                                <div className="grid gap-2">
                                    ...
                                    />
                                    {createErrors.account_name && <p className="text-red-500 text-sm">{createErrors.account_name}</p>}
                                </div>
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        className='border-gray-300 border-[1.7px] rounded-sm'
                                    />
                                    {createErrors.account_code && <p className="text-red-500 text-sm">{createErrors.account_code}</p>}
                                </div>
                                <div className="grid gap-2">
                                    ...
                                    {createErrors.account_type && <p className="text-red-500 text-sm">{createErrors.account_type}</p>}
                                </div>
                                ...
                                {createForm.account_type && (
                                    <div className="grid gap-2">
                                        ...
                                        {createErrors.sub_account_type && <p className="text-red-500 text-sm">{createErrors.sub_account_type}</p>}
                                    </div>
                                )}
                                <div className="grid gap-2">
                                    ...
                                    {createErrors.account_normal_side && <p className="text-red-500 text-sm">{createErrors.account_normal_side}</p>}
                                </div>
                                <div className="grid gap-2">
                                ...
                                accounts.map((account: any) => (
                                    <TableRow key={account.id} className="h-16">
                                        ...
                                        <TableCell className="px-3">
                                            <Link href={route('accounts.show', account.id)} className="hover:underline font-medium">
                                        ...
                                        <TableCell className="px-3 text-xs">
                                            {account.group?.name ? (
                                                <div className="text-blue-600 font-medium leading-tight">
                                                    ...
                                                    {account.group.grp_code && (
                                                        <div className="text-[10px] text-muted-foreground">({account.group.grp_code})</div>
                                                    )}
                                                </div>
                                            ) : (
                                        ...
                                        <TableCell className="text-right px-3">
                                            {account.journal_items_count && account.journal_items_count > 0 ? (
            ...
            <div className="flex items-center justify-between space-x-2 py-4">
                <div className="text-sm text-muted-foreground">
                    Showing {initialAccounts.from} to {initialAccounts.to} of {initialAccounts.total} entries
                </div>
                <div className="space-x-2">
                    <Button
                        ...
                        size="sm"
                        asChild
                        disabled={!initialAccounts.prev_page_url}
                    >
                        <Link
                            href={initialAccounts.prev_page_url || '#'}
                            preserveState
                            preserveScroll
                        >
                            Previous
                    ...
                    <Button
                        ...
                        size="sm"
                        asChild
                        disabled={!initialAccounts.next_page_url}
                    >
                        <Link
                            href={initialAccounts.next_page_url || '#'}
                            preserveState
                            preserveScroll
                        >
                            Next
