...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['permission:view users'])->group(function () {
        ...
        Route::put('dashboard/roles/{role}', [RoleController::class, 'update'])->name('roles.update');
        Route::delete('dashboard/roles/{role}', [RoleController::class, 'destroy'])->name('roles.destroy');
        Route::post('dashboard/roles/{role}/reset', [RoleController::class, 'reset'])->name('roles.reset');
    });
    ...
    Route::middleware(['permission:verify inventory'])->group(function () {
    ...
    Route::middleware(['permission:create trial balance'])->group(function () {
    ...
    Route::middleware(['permission:manage control number prefixes'])->group(function () {
    ...
    // Audit & System
    Route::middleware(['permission:view audit trails'])->group(function () {
